...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Skill Max — แพลตฟอร์มเรียนรู้ขับเคลื่อนด้วย AI" },
      { name: "description", content: "คอร์สสั้นเข้มข้นสำหรับวิศวกรที่สร้างระบบ AI" },
      { name: "author", content: "Skill Max Academy" },
      { property: "og:title", content: "Skill Max — แพลตฟอร์มเรียนรู้ขับเคลื่อนด้วย AI" },
      { property: "og:description", content: "คอร์สสั้นเข้มข้นสำหรับวิศวกรที่สร้างระบบ AI" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Skill Max — แพลตฟอร์มเรียนรู้ขับเคลื่อนด้วย AI" },
